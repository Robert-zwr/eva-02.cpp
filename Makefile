...
eva.o: eva.cpp eva.h
	$(CXX) $(CXXFLAGS) -c eva.cpp -o eva.o
...
main: main.cpp ggml.o eva.o utils.o
	$(CXX) $(CXXFLAGS) main.cpp ggml.o eva.o utils.o -o main $(LDFLAGS)
	@echo
